...
Select c.cat_id,c.cat_name,q.pro_name,min(q.supp_price) as Price_of_Product from category c inner join
...
delimiter &&
create procedure Display_Supplier_Values()
begin
